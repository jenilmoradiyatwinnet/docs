...
//                 type="button"
//                 onClick={() => setActiveImageIndex(index)}
//                 className={`dashboard-tour-inner-tab inline-flex h-[30px] items-center justify-center rounded-full border px-3 text-[13px] font-semibold leading-none transition ${
...
//       {/* Content and screenshot arrows */}
//       <div className="mb-4 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
//         <div className="min-w-0">
//           <p className="text-sm leading-6 text-gray-600 dark:text-gray-300 sm:text-base sm:leading-7">
//             {activeImage.caption || activeSection.description}
//           </p>
//         </div>
...
//       {/* Image */}
//       <div className="overflow-hidden rounded-2xl border border-gray-200 bg-gray-50 shadow-sm dark:border-gray-700 dark:bg-gray-900">
...
export const DashboardTour = () => {
  ...
  return (
    <div className="not-prose m-0 w-full max-w-none p-0">
      ...
      <p className="mt-2 text-[18px] leading-7 text-gray-600 dark:text-gray-400">
  Explore the Twinalyze dashboard step by step.
</p>
      </div>
