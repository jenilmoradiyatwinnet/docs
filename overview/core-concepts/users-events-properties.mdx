...
<div className="twinalyze-bottom-nav">
  <a href="/overview/core-concepts/core-features" className="twinalyze-nav-side">
    <span className="twinalyze-nav-arrow">‹</span>
    <span>Previous</span>
  </a>

  <a href="/overview/core-concepts/auto-capture-events" className="twinalyze-nav-center">
