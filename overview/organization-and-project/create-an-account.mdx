...
<div className="twinalyze-bottom-nav">
  ...
  <a href="/overview/Project-and-Organization/create-your-first-project" className="twinalyze-nav-center">
    <strong>Create your first Project</strong>
    <span>Create your first project in Twinalyze.</span>
  </a>

  <a href="/overview/Project-and-Organization/create-your-first-project" className="twinalyze-nav-side">
    <span>Next</span>
    <span className="twinalyze-nav-arrow">›</span>
  </a>
</div>