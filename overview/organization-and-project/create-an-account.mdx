...
<div className="not-prose my-6 overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
  <div className="border-b border-gray-200 bg-gradient-to-r from-blue-50 to-white px-5 py-4">
    ...
    <p className="mt-2 text-sm text-gray-600">
      Watch this short video to learn how to sign up and set up your organization.
    </p>
  </div>
...
<Steps>
  <Step title="Create your account">
    Sign up using your email and basic details.
  </Step>

  <Step title="Set up organization">
    Create your organization to manage projects and team members.
  </Step>

  <Step title="Continue to project setup">
    After account creation, create your first Twinalyze project.
  </Step>
</Steps>
