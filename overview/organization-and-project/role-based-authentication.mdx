...
<Steps titleSize="h3">
  ...
  <Step title="Send the invitation">
    ...
    <Frame caption="Send the organization invitation">
      ![Send a Twinalyze organization invitation](/images/roles-permissions/send-invite.png)
    </Frame>
  </Step>
  ...
  <Step title="Review the pending invitation">
    ...
    <Frame caption="Review pending organization invitations">
      ![Twinalyze pending user invitations](/images/roles-permissions/pending-user.png)
    </Frame>
  </Step>
</Steps>
