...
description: "Use the Twinalyze Google Tag Manager template to install Twinalyze Web Analytics SDK on your website without manually adding SDK code to every page."
