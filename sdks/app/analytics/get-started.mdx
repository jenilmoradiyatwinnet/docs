...
<div className="twinalyze-bottom-nav-no-prev">
  <a href="/sdks/app/analytics/sdk-initialization" className="twinalyze-nav-center twinalyze-nav-center-no-prev">
    <strong>SDK initialzation</strong>
    <span>Start by SDK initialization.</span>
  </a>

  <a href="/sdks/app/analytics/sdk-initialization" className="twinalyze-nav-side twinalyze-nav-side-next">
    <span>Next</span>
