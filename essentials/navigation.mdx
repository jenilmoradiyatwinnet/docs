...
<Callout icon="pencil" iconType="solid" color="#b05959">
</Callout>
...
<Warning>
  You cannot use `api` for the name of a folder unless you nest it inside<u> </u>another folder. Mintlify uses Next.js which reserves the top-level `api` folder for internal server calls. A folder name such as `api-reference` would be accepted.
</Warning>
